    ...
    <div className="min-h-screen bg-white">
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-6">
            <span className="bg-blue-100 text-blue-800 text-sm font-medium px-3 py-1 rounded-full">Tools</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">How Agencies Should Use Cloud Campaign in 2025</h1>
