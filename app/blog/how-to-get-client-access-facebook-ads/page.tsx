...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://clientfuse.io/api/og?title=How%20to%20Get%20Client%20Access%20to%20Facebook%20Ads&category=Facebook%20Ads', width: 1200, height: 630, alt: 'How to Get Client Access to Facebook Ads' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'How to Get Client Access to Facebook Ads Without the Back-and-Forth',
    description: 'Learn the most effective strategies for getting proper access to your clients\' Facebook Ads accounts, including admin roles, permissions, and common pitfalls to avoid.',
    images: ['https://clientfuse.io/api/og?title=How%20to%20Get%20Client%20Access%20to%20Facebook%20Ads&category=Facebook%20Ads'],
  },
...
export default function BlogPost() {
  const articleSchema = {
    ...
    "description": "Learn the most effective strategies for getting proper access to your clients' Facebook Ads accounts, including admin roles, permissions, and common pitfalls to avoid.",
    "image": "https://clientfuse.io/api/og?title=How%20to%20Get%20Client%20Access%20to%20Facebook%20Ads&category=Facebook%20Ads",
