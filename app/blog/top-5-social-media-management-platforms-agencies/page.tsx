...
export const metadata: Metadata = {
  title: 'Top 5 Social Media Management Platforms for Marketing Agencies in 2024 | ClientFuse Blog',
  description: 'A comprehensive review of the best social media management platforms, ranked by their suitability for marketing agencies managing multiple clients.',
  keywords: 'social media management, marketing agency tools, Cloud Campaign, Metricool, Social Pilot, Vista Social, Agorapulse, agency software, social media scheduling, white-label reporting',
  authors: [{ name: 'ClientFuse' }],
  openGraph: {
    title: 'Top 5 Social Media Management Platforms for Marketing Agencies in 2024',
    description: 'A comprehensive review of the best social media management platforms, ranked by their suitability for marketing agencies managing multiple clients.',
    url: 'https://clientfuse.io/blog/top-5-social-media-management-platforms-agencies',
    siteName: 'ClientFuse',
    type: 'article',
    publishedTime: '2024-01-15T00:00:00.000Z',
    modifiedTime: '2024-01-15T00:00:00.000Z',
    section: 'Tools',
    images: [{ url: 'https://clientfuse.io/api/og?title=Top%205%20Social%20Media%20Management%20Platforms%20for%20Agencies&category=Tools', width: 1200, height: 630, alt: 'Top 5 Social Media Management Platforms for Marketing Agencies' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Top 5 Social Media Management Platforms for Marketing Agencies in 2024',
    description: 'A comprehensive review of the best social media management platforms, ranked by their suitability for marketing agencies managing multiple clients.',
    images: ['https://clientfuse.io/api/og?title=Top%205%20Social%20Media%20Management%20Platforms%20for%20Agencies&category=Tools'],
  },
  alternates: { canonical: 'https://clientfuse.io/blog/top-5-social-media-management-platforms-agencies' },
};
...
export default function BlogPost() {
  const articleSchema = {
    ...
    "@type": "Article",
    "headline": "Top 5 Social Media Management Platforms for Marketing Agencies in 2024",
    "description": "A comprehensive review of the best social media management platforms, ranked by their suitability for marketing agencies managing multiple clients.",
    "image": "https://clientfuse.io/api/og?title=Top%205%20Social%20Media%20Management%20Platforms%20for%20Agencies&category=Tools",
    ...
    "mainEntityOfPage": { "@type": "WebPage", "@id": "https://clientfuse.io/blog/top-5-social-media-management-platforms-agencies" },
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="mt-16 pt-8 border-t border-gray-200">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <Link 
                    href="/blog/how-to-get-client-access-facebook-ads"
                  ...
                  >
                    ...
                    <h4 className="text-gray-900 font-semibold mt-1 line-clamp-2">How to Get Client Access to Facebook Ads Without the Back-and-Forth</h4>
                  </Link>
                  <Link 
